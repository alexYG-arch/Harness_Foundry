"""Legacy v0.1 candidate plus execution-evidence validator.

This module is retained only for read-only migration fixtures. New Factory
validation is implemented in ``validator.py`` and never inspects a live
execution root.
"""
