    ...
    if workpack_id in {
        ...
        if workpack_id in {"LAB-PROTOCOL", "LAB-CLI"}:
            lab_contract["protocol_implementation_support"] = {
                ...
                "frozen_contract_checks_ref": "harness-resource://candidate/tools/harness_foundry_runtime/lab_protocol_contract_checks.py",
                "frozen_contract_check_entrypoint": "harness_foundry_runtime.lab_protocol_contract_checks:verify_frozen_protocol_contract",
                "frozen_contract_check_scope": "FROZEN_PROTOCOL_DECLARATIONS_ONLY",
