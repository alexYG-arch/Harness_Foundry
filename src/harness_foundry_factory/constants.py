...
from .identity import (
    FACTORY_ID, BASELINE_FACTORY_ID, TARGET_PROTOCOL_VERSION, FACTORY_VERSION, SCHEMA_VERSION,
)
...
EPOCH38_LOCAL_ROOT_MATERIALIZATION_REQUIREMENT_SOURCES = {
    "CHARTER_LOCK_VALID": "ENGINEERING_DAG:SHARED_CONTROL_BASELINE_LOCK",
    "PROFILE_LOCK_VALID": "ENGINEERING_DAG:START_PACKAGE_HUMAN_APPROVAL",
}
...
EPOCH38_LOCAL_RELEASE_REQUIREMENT_SOURCES = {
    "P4_LOCAL_GATE_PASS": "PROJECT_WORKPACK:MB-P4",
    "OFFICIAL_CORE_VALIDATION_PASS": (
        "EPOCH38_GENERATION_PROFILE:core_validation_sha256"
    ),
    "CORE_EVIDENCE_PROJECTION_PASS": (
        "EPOCH38_GENERATION_PROFILE:core_evidence_projection_sha256"
    ),
}
...
ROOT_LAYER_VALIDATION_SCOPE = "STRUCTURAL_PACKAGE_CONTRACT_ONLY"
ROOT_LAYER_BEHAVIORAL_ATOM_POLICY = (
    "DEFER_TO_COVERAGE_ROUTED_PROJECT_WORKPACKS"
)
