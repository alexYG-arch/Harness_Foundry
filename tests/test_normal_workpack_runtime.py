...
class NormalWorkpackRuntimeTests(unittest.TestCase):
    ...
    def test_candidate_packages_local_runtime_import_closure(self):
        for name in ("local_runtime.py", "local_process.py", "startup_runtime.py", "coding_protocol.py",
                     ...
                     "lab_protocol_contract_checks.py",
        ...
        code = ("from harness_foundry_runtime.local_runtime import LOCAL_MODE; "
                ...
                "from harness_foundry_runtime.workpack_acceptance import plan_workpack_completion; "
                "from harness_foundry_runtime.lab_protocol import derive_job_id; "
                "from harness_foundry_runtime.lab_protocol_checks import verify_protocol_primitives; print(LOCAL_MODE)")
